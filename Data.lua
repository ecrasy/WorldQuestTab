...
_V["SETTING_LIST"] = {
    ...
    {
        ["template"] = "WQT_SettingProfileDropDownTemplate",
        ["categoryID"] = "PROFILES",
        ["label"] = _L["CURRENT_PROFILE"],
        ["tooltip"] = _L["CURRENT_PROFILE_TT"],
        ["options"] = function()
            return WQT_Profiles:GetProfiles()
        end,
        ...
        ["getValueFunc"] = function()
            return WQT_Profiles:GetIndexById(WQT.db.char.activeProfile)
        end
    },
    {
        ...
        ["isDisabled"] = function()
            return WQT_Profiles:DefaultIsActive()
        end
    },
    {
    ...
    -- General settings
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.defaultTab
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.saveFilters
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.preciseFilters
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.useLFGButtons
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.questCounter
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.alwaysAllQuests
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.includeDaily
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ["categoryID"] = "GENERAL",
        ["label"] = _L["ALIGN_WORLDMAP_BUTTON"],
        ["tooltip"] = _L["ALIGN_WORLDMAP_BUTTON_TT"],
        ["isNew"] = true,
        ["valueChangedFunc"] = function(value)
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.alignWorldMapButton
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.df_goldPurses
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.sl_callingsBoard
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.sl_genericAnimaIcons
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.autoEmissary
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.bountyCounter
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.bountyReward
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.general.bountySelectedOnly
        end
    },
    -- Quest List
    {["frameName"] = "WQT_SettingsQuestListPreview", ["categoryID"] = "QUESTLIST"},
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.typeIcon
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.factionIcon
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.showZone
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ["categoryID"] = "QUESTLIST",
        ["label"] = _L["SHOW_WARBAND_BONUS"],
        ["tooltip"] = _L["SHOW_WARBAND_BONUS_TT"],
        ["isNew"] = true,
        ["valueChangedFunc"] = function(value)
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.showWarbandBonus
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.rewardNumDisplay
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.amountColors
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.colorTime
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.list.fullTime
        end
    },
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.fadeOnPing
        end,
        ["isDisabled"] = function()
    ...
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.filterPoI
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    ...
    {["template"] = " WQT_SettingSubTitleTemplate", ["categoryID"] = "MAPPINS", ["label"] = APPEARANCE_LABEL},
    {
        ["template"] = "WQT_SettingCheckboxTemplate",
        ["categoryID"] = "MAPPINS",
        ["label"] = _L["PIN_WARBAND_BONUS"],
        ["tooltip"] = _L["PIN_WARBAND_BONUS_TT"],
        ["isNew"] = true,
        ["valueChangedFunc"] = function(value)
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.showWarbandBonus
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.eliteRing
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    ...
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.centerType
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    ...
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.zoneVisible
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.continentVisible
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    ...
    --,{["template"] = "WQT_SettingSubTitleTemplate", ["categoryID"] = "MAPPINS", ["label"] = _L["MINI_ICONS"]}
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.typeIcon
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.rarityIcon
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.timeIcon
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
    },
    {
        ...
        ["getValueFunc"] = function()
            return WQT.settings.pin.numRewardIcons
        end,
        ["isDisabled"] = function()
            return WQT.settings.pin.disablePoI
        end
...
_V["WQT_TYPEFLAG_LABELS"] = {
    [2] = {
        ...
        ["Skyriding"] = DRAGONRIDING_RACES_MAP_TOGGLE
    },
    [3] = {
        ["Item"] = ITEMS,
    ...
    ["questType"] = function(a, b)
        ...
        if
            (tagInfoA and tagInfoB and tagInfoA.worldQuestType and tagInfoB.worldQuestType and
                tagInfoA.worldQuestType ~= tagInfoB.worldQuestType)
         then
        ...
        if (mapInfoA and mapInfoA.name and mapInfoB and mapInfoB.name and mapInfoA.mapID ~= mapInfoB.mapID) then
            if
                (WQT.settings.list.alwaysAllQuests and
                    (mapInfoA.mapID == WorldMapFrame.mapID or mapInfoB.mapID == WorldMapFrame.mapID))
             then
...
_V["REWARD_TYPE_ATLAS"] = {
    ...
    [WQT_REWARDTYPE.honor] = {
        ["texture"] = _playerFaction == "Alliance" and "poi-alliance" or "poi-horde",
        ["scale"] = 1
    }, -- Honor
...
_V["FILTER_FUNCTIONS"] = {
    [2] = {
        -- Types
        ["PvP"] = function(questInfo, tagInfo)
            return tagInfo and
                (tagInfo.worldQuestType == Enum.QuestTagType.PvP or tagInfo.worldQuestType == Enum.QuestTagType.Bounty)
        end,
        ["Petbattle"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.PetBattle
        end,
        ["Dungeon"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.Dungeon
        end,
        ["Raid"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.Raid
        end,
        ["Profession"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.Profession
        end,
        ["Invasion"] = function(questInfo, tagInfo)
            return tagInfo and
                (tagInfo.worldQuestType == Enum.QuestTagType.Invasion or
                    tagInfo.worldQuestType == Enum.QuestTagType.InvasionWrapper)
        end,
        ["Assault"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.FactionAssault
        end,
        ["Elite"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.isElite and tagInfo.worldQuestType ~= Enum.QuestTagType.Dungeon
        end,
        ["Default"] = function(questInfo, tagInfo)
            return tagInfo and
                ((not tagInfo.isElite and tagInfo.worldQuestType == Enum.QuestTagType.Normal) or
                    tagInfo.worldQuestType == Enum.QuestTagType.CovenantCalling)
        end,
        ["Daily"] = function(questInfo, tagInfo)
        ...
        ["Skyriding"] = function(questInfo, tagInfo)
            return tagInfo and tagInfo.worldQuestType == Enum.QuestTagType.DragonRiderRacing
        end
    },
    [3] = {
        -- Reward filters
        ["Armor"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.equipment + WQT_REWARDTYPE.weapon) > 0
        end,
        ["Relic"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.relic) > 0
        end,
        ["Item"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.spell + WQT_REWARDTYPE.item) > 0
        end,
        ["Anima"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.anima) > 0
        end,
        ["Conduits"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.conduit) > 0
        end,
        ["Artifact"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.artifact) > 0
        end,
        ["Honor"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.honor) > 0
        end,
        ["Gold"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.gold) > 0
        end,
        ["Currency"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.currency) > 0
        end,
        ["Experience"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.xp) > 0
        end,
        ["Reputation"] = function(questInfo, tagInfo)
            return bit.band(questInfo.reward.typeBits, WQT_REWARDTYPE.reputation) > 0
        end,
        ["None"] = function(questInfo, tagInfo)
            return questInfo.reward.typeBits == WQT_REWARDTYPE.none
        end
    }
}
-- /dump WorldMapFrame:GetMapID()
...
_V["WQT_ZONE_MAPCOORDS"] = {
    ...
    [2241] = {
        -- Emerald Dream flightmap
        [2200] = {["x"] = 0, ["y"] = 0} -- Emerald Dream
    },
    [2175] = {
        -- Zaralek Cavern flightmap
    ...
    [947] = {
        -- All of Azeroth (Also look at UpdateAzerothZones() in Dataprovider.lua)
        [12] = {["x"] = 0.24, ["y"] = 0.55},
        [13] = {["x"] = 0.89, ["y"] = 0.52},
        [113] = {["x"] = 0.49, ["y"] = 0.12},
        [424] = {["x"] = 0.48, ["y"] = 0.82},
