...
function WQT_CallingsBoardMixin:CalculateUncappedObjectives(calling)
    ...
    for objectiveIndex = 1, calling.numObjectives do
        local objectiveText, objectiveType, finished, numFulfilled, numRequired =
            GetQuestObjectiveInfo(calling.questID, objectiveIndex, false)
